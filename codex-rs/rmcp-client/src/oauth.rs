...
impl OAuthPersistor {
    ...
    pub(crate) async fn refresh_if_needed_with_timeout(
        ...
        self.refresh_if_needed_with_keyring_store_and_timeout(&DefaultKeyringStore, overall_timeout)
            .await
    }
    ...
    pub(crate) async fn refresh_after_unauthorized_with_timeout(
        ...
        self.refresh_after_unauthorized_with_keyring_store_and_timeout(
            &DefaultKeyringStore,
            overall_timeout,
        )
        .await
    ...
    async fn refresh_if_needed_with_keyring_store_and_timeout<K: KeyringStore + Clone + 'static>(
        ...
        self.refresh_transaction(keyring_store, RefreshReason::Expiry, overall_timeout)
            .await
    }
    ...
    async fn refresh_after_unauthorized_with_keyring_store_and_timeout<
    ...
    >(
        ...
        self.refresh_transaction(keyring_store, RefreshReason::Unauthorized, overall_timeout)
            .await
    }
...
impl RefreshCredentialLock {
    async fn acquire_for_server(server_name: &str, url: &str) -> Result<Self> {
        Self::acquire_for_server_with_timeout(server_name, url, LOCK_ACQUIRE_TIMEOUT).await
    }
