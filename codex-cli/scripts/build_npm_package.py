#!/usr/bin/env python3
"""Stage and optionally package the @agticorp/pfterminal npm module."""
...
CODEX_NPM_NAME = "@agticorp/pfterminal"
CODEX_PACKAGE_COMPONENT = "codex-package"

# `npm_name` is the local optional-dependency alias consumed by `bin/codex.js`.
# The underlying package published to npm is always `@agticorp/pfterminal`.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "codex-linux-x64": {
        "npm_name": "@agticorp/pfterminal-linux-x64",
        "npm_tag": "linux-x64",
    ...
    "codex-linux-arm64": {
        "npm_name": "@agticorp/pfterminal-linux-arm64",
        "npm_tag": "linux-arm64",
    ...
    "codex-darwin-x64": {
        "npm_name": "@agticorp/pfterminal-darwin-x64",
        "npm_tag": "darwin-x64",
    ...
    "codex-darwin-arm64": {
        "npm_name": "@agticorp/pfterminal-darwin-arm64",
    ...
    "codex-win32-x64": {
        "npm_name": "@agticorp/pfterminal-win32-x64",
        "npm_tag": "win32-x64",
    ...
    "codex-win32-arm64": {
        "npm_name": "@agticorp/pfterminal-win32-arm64",
        "npm_tag": "win32-arm64",
